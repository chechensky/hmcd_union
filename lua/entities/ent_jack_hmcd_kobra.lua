...
File Path:   gamemodes/homicide/entities/entities/ent_jack_hmcd_kobra.lua
...
ENT.Model = "models/weapons/tfa_ins2/upgrades/phy_optic_kobra.mdl"
ENT.EquipmentNum = HMCD_KOBRA